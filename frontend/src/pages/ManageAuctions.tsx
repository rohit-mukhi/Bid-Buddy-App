        ...
        <div className="row">
          <div className="col-lg-10 mx-auto">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                <h1 className="display-4 fw-bold" style={{ color: 'var(--teal)' }} data-aos="fade-down">
                  My Auctions
                </h1>
                    ...
                    <div className="card bg-dark-card border-secondary h-100">
                      <div className="position-relative" style={{ height: '200px', overflow: 'hidden' }}>
                        ...
                        <span className="badge bg-primary position-absolute top-0 end-0 m-3">
                          {getTimeRemaining(auction.expiresAt)}
                        </span>
                      </div>
                      <div className="card-body">
                        ...
                        <div className="d-flex justify-content-between mb-3">
                          <div>
                            ...
                            <strong className="text-white">${auction.currentBid}</strong>
                          </div>
          ...
          <div className="row mb-4">
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              ...
              <ul className="list-unstyled">
                ...
                <li><a href="#" className="text-white-50 text-decoration-none">Cookie Policy</a></li>
              </ul>
            </div>
            <div className="col-lg-3 col-md-6 mb-4">
